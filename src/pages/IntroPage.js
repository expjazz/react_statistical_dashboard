  ...
  return (
    <StyledIntro>
      ...
      <p>
        ...
        analysis about the popularity
        of the world leaders throughout the
        social media. The data is fake as the
        goal of this is showcase a possible and viable react application
